...
\begin{definition}[Combinatorial class, {\cite[Definition 2.2]{Melczer2021}, \cite[Chapter 2]{MelczerNotes}}]
...
\begin{definition}[Generating function, {\cite[Definition 2.2]{Melczer2021}, \cite[Chapter 2]{MelczerNotes}}]
...
To build generating functions without first calculating counting sequences, we define combinatorial operations on classes that translate directly into algebraic operations on their generating functions (see \cite[Chapter 5]{MelczerNotes} and \cite[Chapter I]{FlajoletSedgewick2009}).
...
\begin{example}[Compositions, {\cite[Chapter 5]{MelczerNotes}}]
