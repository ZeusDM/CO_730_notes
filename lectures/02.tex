...
\begin{example}[Rooted planar binary trees parameterized by leaves]
...
The \emph{expected value} of a parameter \(\chi\) over all objects of size \(n\) is
\[
...
\begin{example}[Expected number of leaves in a binary tree]
