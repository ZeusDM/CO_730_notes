...
\begin{example}[Analytic continuation of a geometric series, {\cite[Example 2.30]{Melczer2021}}]
...
\begin{example}[Non-uniqueness of analytic continuation, {\cite[Example 2.33]{Melczer2021}}]
...
\begin{definition}[Contour integral, {\cite[Appendix, p.~77]{Melczer2021}}]
...
\begin{proposition}[{\cite[Appendix, p.~78]{Melczer2021}}]
...
\begin{example}[Contour integrals of \(z^n\), {\cite[Example 2.31]{Melczer2021}}]
...
\begin{theorem}[Jordan curve theorem, {\cite[Appendix, p.~78]{Melczer2021}}]
...
\begin{proposition}[Path independence and Cauchy's theorem, {\cite[Proposition 2.20]{Melczer2021}}]
...
\begin{proposition}[Maximum modulus integral bound (\(ML\)-inequality), {\cite[Proposition 2.22]{Melczer2021}}]
